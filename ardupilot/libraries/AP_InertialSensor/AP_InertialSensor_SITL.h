...
const uint16_t INS_SITL_SENSOR_A[] = { 3200, 1600}; //1000, 1000 }; //original
const uint16_t INS_SITL_SENSOR_B[] = { 3200, 1600}; //760, 800 }; //original
...
private:
    ...
    uint16_t gyro_sample_hz; //const (before)
    uint16_t accel_sample_hz; //const (before)
    ...
    bool SIMULATE_BMI270_SUSPEND = false;
    bool SIMULATE_INVENSENSE_SUSPEND = true;
    uint64_t attack_stop = 0UL;
    float gyro_time;
    float accel_time;
