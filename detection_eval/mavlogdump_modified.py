...
# *** ***
# Include user-defined data fields
if match_types[0] in ['AC', 'GT', 'RAC', 'RGY']:
    fields = ['timestamp','TimeUS']
    if match_types[0] =='AC':
        fields.append('Ground_Truth')
    elif match_types[0] =='GT':
        fields.append('Ground_Truth')
    elif match_types[0] == 'RAC':
        fields.append('ACCx')
    elif match_types[0] == 'RGY':
        fields.append('GYROx')
    csv_out = ["" for x in fields]
    print(args.csv_sep.join(fields))
